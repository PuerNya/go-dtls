...
| `ConnectionState` | Возвращает версию, набор шифров, ALPN, сертификаты, состояние возобновления, активные CID и состояние согласования RRC |
...
Не реализованы необязательные расширения RFC 8449 `record_size_limit`, RFC 8879 Certificate Compression, RFC 9149 Ticket Requests, RFC 9257/9258 external PSK, RFC 9849 ECH и RFC 9954 Hybrid Key Exchange.
...
| --- | --- |
| Полное сертификатное рукопожатие и закрытие, `BenchmarkConnectionHandshakeLifecycle` | Около `646.3 us/op`, `111838 B/op`, `872 allocs/op` |
| Полный mTLS, `BenchmarkMutualTLSHandshakeLifecycle/Full` | Около `868.7 us/op`, `135791 B/op`, `1165 allocs/op` |
| Возобновленный mTLS, `BenchmarkMutualTLSHandshakeLifecycle/Resumed` | Около `439.8 us/op`, `117434 B/op`, `821-822 allocs/op` |
| Seal AES-128-GCM для 1200 B | Около 1.50-1.51 GB/s, 1 alloc/op |
| In-place round trip AES-128-GCM для 1200 B | Около 862-954 MB/s, 1 alloc/op |
...
| Создание защищенного flight 4 KiB / MTU 1200 | Около 3.00-3.26 us/op, 5616 B/op, 6 allocs/op |
